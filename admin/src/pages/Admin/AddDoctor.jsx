        ...
        <form onSubmit={onSubmitHandler} className='m-5 w-full'>
            ...
            <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
                <div className='flex items-center gap-4 mb-8 text-gray-500'>
                    ...
                    <p>Tải lên hình <br /> bác sĩ</p>
                </div>

                <div className='flex flex-col lg:flex-row items-start gap-10 text-gray-600'>

                    <div className='w-full lg:flex-1 flex flex-col gap-4'>                        <div className='flex-1 flex flex-col gap-1'>
                            <p>Tên của bạn</p>
                            <input onChange={e => setName(e.target.value)} value={name} className='border rounded px-3 py-2' type="text" placeholder='Họ tên' required />
                        </div>
                        ...
                        <div className='flex-1 flex flex-col gap-1'>
                            <p>Kinh nghiệm</p>
                            <select onChange={e => setExperience(e.target.value)} value={experience} className='border rounded px-2 py-2' >                                <option value="1 Year">1 năm</option>
                        ...
                        </div>                        <div className='flex-1 flex flex-col gap-1'>
                            <p>Phí khám</p>
                            <input onChange={e => setFees(e.target.value)} value={fees} className='border rounded px-3 py-2' type="number" placeholder='Phí khám bác sĩ' required />
                        </div>
                    ...
                    <textarea onChange={e => setAbout(e.target.value)} value={about} className='w-full px-4 pt-2 border rounded' rows={5} placeholder='Viết giới thiệu về bác sĩ'></textarea>
                </div>
